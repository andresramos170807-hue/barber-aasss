    ...
    lineasDeVenta(v).forEach(l => {
      ...
      if (a.tipo === 'Producto') {
        if (a.usoInterno) {
          ...
          // Facturacion de PRODUCTOS, aparte de los servicios
          E.fact_productos += (a.importe || 0);
        }
...
const server = http.createServer(async (req, res) => {
  ...
  if ((req.url.startsWith('/api/debug') || req.url.startsWith('/api/probargastos') || req.url.startsWith('/api/probarfotos') || req.url.startsWith('/api/comparar-facturacion')) && usuario.rol !== 'admin') {
