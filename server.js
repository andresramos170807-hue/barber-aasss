...
const server = http.createServer(async (req, res) => {
  ...
  if ((req.url.startsWith('/api/debug') || req.url.startsWith('/api/probargastos') || req.url.startsWith('/api/probarfotos') || req.url.startsWith('/api/comparar-facturacion') || req.url.startsWith('/api/probar-ultimodia')) && usuario.rol !== 'admin') {
