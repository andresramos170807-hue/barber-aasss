...
const GUIA_SECCIONES = {
  ...
  objetivos: {
    titulo: 'Objetivos',
    mira: 'okr con facturacion y las dos calidades',
    enfoque: 'Compara el % logrado con el % de mes transcurrido. Di si llegaran o no, y que haria falta para llegar. Si falta la auditoria de calidad, recuerdalo.',
  },
};
