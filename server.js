      ...
      try {
        ...
        const r = await fetch('https://api.anthropic.com/v1/messages', {
          ...
          body: JSON.stringify({
            ...
            messages: [{
              role: 'user',
              content: `Eres el encargado de compras de la barberia LeBarbier ${local}. Este es el stock y las ventas de este mes:\n\n${resumen}\n\nAnaliza y responde SOLO con JSON valido, sin markdown:\n{\n  "resumen": "una frase sobre el estado general del almacen",\n  "hay_que_reponer": ["producto: motivo (existencias bajas/agotado)"],\n  "dar_salida": ["producto: tiene mucho stock y no se vende, sugiere promo o colocarlo a la vista"],\n  "producto_mas_acumulado": "el que mas unidades tiene paradas",\n  "accion_semana": "la accion mas importante a hacer esta semana"\n}\n\nEn español, concreto y practico para una barberia.`
            }]
          })
        });
        const j = await r.json();
